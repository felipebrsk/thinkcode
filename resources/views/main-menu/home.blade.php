...
@section('content')
    ...
    @php
    $concludeChallenges = DB::table('user_courses')
        ->where('user_id', '=', Auth::user()->id)
        ->select('challenge');
    $allChallenges = DB::table('coruses')->select('challenges');
    @endphp
    ...
    <main class="p-6 sm:p-10 space-y-6">
        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    @if (isset($media))
                        <span class="block text-2xl font-bold">{{ Str::limit($media, 4, '') }}</span>
                    @else
                        <span class="block text-2xl font-bold">0</span>
                    @endif
                    <span class="block text-gray-500">Minha média geral no ThinkCode</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                <div
                ...
                <div>
                    @if (isset($count))
                        <span class="inline-block text-2xl font-bold">{{ $count }} de {{ $geral }}</span>
                        <span class="inline-block text-xl text-gray-500 font-semibold">({{ $percent }}%)</span>
                    @else
                        <span class="inline-block text-2xl font-bold">0</span>
                    @endif
                    <span class="block text-gray-500">Matérias abaixo da média</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                <div
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Tarefas finalizadas</span>
                </div>
            </div>
        </section>
        <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
            <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div class="px-6 py-5 font-semibold border-b border-gray-100">O número de alunos inscritos e abandonados por
                    mês</div>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Tarefas a fazer</span>
                </div>
            </div>
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                <div
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Horas gastas na plataforma</span>
                </div>
            </div>
            <div class="row-span-3 bg-white shadow rounded-lg">
                <div class="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                    <span>Alunos por média</span>
            ...
            <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
                <div class="px-6 py-5 font-semibold border-b border-gray-100">Estudantes por tipo de estudo</div>
                <div class="p-4 flex-grow">
                    <div
