...
<aside class="hidden sm:flex sm:flex-col">
    ...
    <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
        ...
        <a href="{{ route('mail.trap') }}" class="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
...
@foreach ($courses as $course)
        <div class="w-96">
            <figure title="{{$course->name}}"><a href="{{ route('show', $course->id) }}"><img src="{{ asset('/images/' . $course->picture) }}"></a></figure>
        </div>
@endforeach
</section>
